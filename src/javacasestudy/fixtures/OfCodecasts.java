...
public class OfCodecasts {
  ...
  public List<Object> query() {
    ...
    for (PresentableCodecast pcc : presentableCodecasts) {
      List<Object> row = makeRow(pcc.title(), pcc.title(), pcc.title(), pcc.isViewable(), false);
  ...
  private List<Object> makeRow(
    String title, String picture, String description, boolean isViewable, boolean isDownloadable
  ) {
    return list(
      list("title", title),
